...
export const products: Product[] = [
  ...
  // Elmeasure Products - Source Changeover Switches
  {
    id: 'elmeasure-ats',
    name: 'Automatic Transfer Switches (ATS)',
    brand: 'Elmeasure',
    category: 'Switchgear',
    description: 'Reliable automatic switching between power sources for continuous supply. Ensures seamless transfer of power between primary and backup sources.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Type": "Automatic",
  ...
  {
    id: 'elmeasure-mts',
    name: 'Manual Transfer Switches (MTS)',
    brand: 'Elmeasure',
    category: 'Switchgear',
    description: 'Robust manual switching solutions for safe power source management. Designed for safety and durability in industrial and commercial settings.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Type": "Manual",
      "Durability": "High",
  ...
  {
    id: 'elmeasure-accl',
    name: 'Automatic Changeover with Current Limiter (ACCL)',
    brand: 'Elmeasure',
    category: 'Switchgear',
    description: 'Intelligent changeover with overload protection and current limiting features. Automatically switches to generator supply during power failure.',
    imageId: 'elmeasure-placeholder',
    specifications: {
  ...
  {
    id: 'elmeasure-solenoid-ats',
    name: 'Solenoid-Based ATS',
    brand: 'Elmeasure',
    category: 'Switchgear',
    description: 'High-speed transfer switch using solenoid mechanism for fast switching. Suitable for sensitive electronic equipment.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Mechanism": "Solenoid Drive",
      "Speed": "High Speed",
      "Application": "Sensitive Electronics",
    },
  },
  {
    id: 'elmeasure-static-ts',
    name: 'Static Transfer Switches',
    brand: 'Elmeasure',
    category: 'Switchgear',
    description: 'Solid-state transfer switches for instantaneous power switching (<4ms). Ensures zero interruption for critical loads.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Technology": "SCR (Solid State)",
      "Transfer Time": "<4ms",
      "Reliability": "Ultra High",
    },
  },
  // Elmeasure Products - Energy and Power Monitors
  {
    id: 'elmeasure-dc-meter',
    name: 'DC Energy Meters',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Precision metering for DC power systems, solar PV, and battery monitoring. Measures DC voltage, current, power, and energy.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Measurement": "DC Parameters",
      "Application": "Solar/Telecom",
      "Accuracy": "High Precision",
    },
  },
  {
    id: 'elmeasure-branch-monitor',
    name: 'Branch Circuit Power Monitors',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Multi-channel monitoring for high-density power distribution units. Ideal for data centers to track energy at the branch circuit level.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Channels": "Multi-channel",
      "Application": "Data Centers",
      "Type": "Branch Monitoring",
    },
  },
  {
    id: 'elmeasure-basic-meter',
    name: 'Basic Digital Meters',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Cost-effective digital meters for reliable measurement of voltage, current, and frequency.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Parameters": "V, I, Hz",
      "Display": "Digital",
  ...
  {
    id: 'elmeasure-pq-monitor',
    name: 'Power Quality Monitors',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Advanced monitoring of power quality events like sags, swells, harmonics, and transients.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Detection": "Sags, Swells, Transients",
      "Analysis": "Harmonics",
      "Usage": "Diagnostic",
    },
  },
  {
    id: 'elmeasure-multifunction-meter',
    name: 'Multi-Functional Energy Meters',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Comprehensive metering solution measuring V, I, F, PF, KW, KVA, KVAR, and energy. BMS integration ready.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Parameters": "All Electrical",
      "Communication": "BMS Ready",
      "Versatility": "High",
    },
  },
  {
    id: 'elmeasure-pq-analyzer',
    name: 'Power Quality Analysers',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'High-end analyzers for detailed harmonic analysis, waveform capture, and compliance reporting.',
    imageId: 'elmeasure-placeholder',
    specifications: {
      "Analysis": "Deep Harmonic",
      "Feature": "Waveform Capture",
      "Reporting": "Compliance",
    },
  },
  {
    id: 'elmeasure-portable-analyzer',
    name: 'Portable PQ Analyzers',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Rugged handheld analyzers for on-site power quality audits and troubleshooting.',
    imageId: 'elmeasure-placeholder',
    specifications: {
  ...
  {
    id: 'elmeasure-iot-meter',
    name: 'IoT Energy Meters',
    brand: 'Elmeasure',
    category: 'Meters & Monitoring',
    description: 'Smart meters with built-in IoT connectivity for real-time cloud monitoring and analytics.',
    imageId: 'elmeasure-placeholder',
    specifications: {
