                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-2 gap-8 items-center">
                                {brands.map((brand) => (
                                    <div key={brand.id} className="flex items-center justify-center p-4 bg-white dark:bg-white/5 rounded-lg border border-gray-100 dark:border-white/10 shadow-sm">
                                        <Image
                                            src={brand.logo}
                                            alt={`${brand.name} logo`}
                                            width={140}
