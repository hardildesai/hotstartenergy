...
export function SecureMetersLogo({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M55 15c0-6.9 5.6-12.5 12.5-12.5S80 8.1 80 15s-5.6 12.5-12.5 12.5S55 21.9 55 15zm23-10.5c-5.8 0-10.5 4.7-10.5 10.5s4.7 10.5 10.5 10.5 10.5-4.7 10.5-10.5S73.8 4.5 68 4.5z" />
