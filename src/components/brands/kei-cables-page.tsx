...
export function KeiCablesPage({ brand }: { brand: Brand }) {
  ...
  return (
    <BrandPageLayout
      brand={{
        name: "Quality Cables for Every Application",
        logo: brand.logo,
        description: "Hotstart Energy is your authorized partner for KEI Cables, delivering performance and reliability for India’s most demanding projects."
      }}
      heroImage={heroImage}
    >
      {/* Intro Section */}
