    ...
    <div className="flex flex-col">
      ...
      <Dialog>
                            ...
                            >
                                ...
                                <div className="mt-4 pt-4 border-t flex items-center justify-center gap-2">
                                    ...
                                    <DialogTrigger asChild>
                                        <Button size="sm" variant="outline" onClick={() => setSelectedProduct(product)}>Know More</Button>
                                    </DialogTrigger>
                                </div>
                            </motion.div>
                        )
        ...
        <DialogContent className="sm:max-w-[425px]">
            ...
            <DialogFooter>
                <Button asChild>
                    <Link href={selectedProduct?.url || '/'} target="_blank" rel="noopener noreferrer">Visit Legrand Website</Link>
                </Button>
            </DialogFooter>
        </DialogContent>
      </Dialog>
