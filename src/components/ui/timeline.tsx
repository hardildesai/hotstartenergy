...
export const Timeline = ({ data, heading, subheading }: { data: TimelineEntry[], heading: string, subheading: string }) => {
  ...
  return (
    <div
      className="w-full bg-gray-50/50 dark:bg-gray-900/20 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-center">
        <h2 className="text-3xl md:text-4xl mb-4 font-bold tracking-tight text-black dark:text-white max-w-4xl mx-auto">
          {heading}
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-lg md:text-base max-w-2xl mx-auto">
          {subheading}
        </p>
      </div>
